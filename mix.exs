...
defmodule Bonfire.XMPP.MixProject do
  use Mix.Project
  ...
  def project do
    ...
    [
      ...
      description: "An extension for Bonfire",
        ...
        source_url: "https://github.com/bonfire-networks/bonfire_xmpp",
        package: [
          licenses: ["AGPL-3.0"],
          links: %{
            "Repository" => "https://github.com/bonfire-networks/bonfire_xmpp",
            "Hexdocs" => "https://hexdocs.pm/bonfire_xmpp"
          }
        ],
        docs: [
